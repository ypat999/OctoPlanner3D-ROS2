...
: ${AMENT_CURRENT_PREFIX:="/workspace/OctoPlanner3D-ROS2/install/octo_planner3d"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/octo_planner3d/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/octo_planner3d/environment/path.sh"
